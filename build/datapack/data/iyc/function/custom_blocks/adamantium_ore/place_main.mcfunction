...
execute align xyz positioned ~.5 ~.5 ~.5 summon item_display at @s run function iyc:custom_blocks/adamantium_ore/place_secondary
...
scoreboard players add #total_adamantium_ore iyc.data 1
