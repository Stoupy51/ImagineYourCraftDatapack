...
execute as @n[type=item,nbt={Item:{id:"minecraft:structure_void"}},distance=..1] run function iyc:custom_blocks/black_flower/replace_item
...
scoreboard players remove #total_black_flower iyc.data 1
