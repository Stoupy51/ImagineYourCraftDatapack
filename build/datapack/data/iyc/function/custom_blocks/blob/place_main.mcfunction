...
#> iyc:custom_blocks/blob/place_main
#
# @within	???
#
...
execute align xyz positioned ~.5 ~.5 ~.5 summon item_display at @s run function iyc:custom_blocks/blob/place_secondary
...
scoreboard players add #total_blob iyc.data 1
