...
execute as @e[type=item,nbt={Item:{id:"minecraft:polished_deepslate"}},limit=1,sort=nearest,distance=..1] run function iyc:custom_blocks/deepslate_adamantium_ore/replace_item
