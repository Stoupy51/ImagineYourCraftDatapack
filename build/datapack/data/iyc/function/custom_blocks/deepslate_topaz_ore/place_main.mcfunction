...
execute align xyz positioned ~.5 ~.5 ~.5 summon item_display at @s run function iyc:custom_blocks/deepslate_topaz_ore/place_secondary
...
scoreboard players add #total_deepslate_topaz_ore iyc.data 1
