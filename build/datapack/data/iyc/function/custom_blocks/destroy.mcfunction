...
execute if score #total_vanilla_raw_iron_block iyc.data matches 1.. if entity @s[tag=iyc.vanilla.minecraft_raw_iron_block] unless block ~ ~ ~ minecraft:raw_iron_block run function iyc:custom_blocks/_groups/minecraft_raw_iron_block
