...
#> iyc:custom_blocks/iron_lantern/place_main
#
...
execute align xyz positioned ~.5 ~.5 ~.5 summon item_display at @s run function iyc:custom_blocks/iron_lantern/place_secondary
...
scoreboard players add #total_iron_lantern iyc.data 1
