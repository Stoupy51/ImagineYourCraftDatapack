...
execute as @e[type=item,nbt={Item:{id:"minecraft:ochre_froglight"}},limit=1,sort=nearest,distance=..1] run function iyc:custom_blocks/jungle_wood_lantern/replace_item
