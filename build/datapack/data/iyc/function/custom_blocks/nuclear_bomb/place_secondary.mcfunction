...
# Add a custom name
data merge entity @s {"CustomName": {"text": "Nuclear Bomb","italic": false,"color": "white"}}


# Modify item display entity to match the custom block
item replace entity @s container.0 with minecraft:furnace[item_model="iyc:nuclear_bomb"]
