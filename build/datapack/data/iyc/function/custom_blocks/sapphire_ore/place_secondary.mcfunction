...
#> iyc:custom_blocks/sapphire_ore/place_secondary
#
# @within	iyc:custom_blocks/sapphire_ore/place_main
#
...
tag @s add iyc.sapphire_ore
tag @s add iyc.vanilla.minecraft_polished_deepslate

# Modify item display entity to match the custom block
item replace entity @s container.0 with minecraft:furnace[minecraft:custom_model_data=2015014]
