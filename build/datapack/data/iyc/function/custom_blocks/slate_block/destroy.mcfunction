...
execute as @n[type=item,nbt={Item:{id:"minecraft:coal_block"}},distance=..1] run function iyc:custom_blocks/slate_block/replace_item
...
scoreboard players remove #total_slate_block iyc.data 1
