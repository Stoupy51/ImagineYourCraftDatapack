...
#> iyc:custom_blocks/slate_block/place_main
#
...
execute align xyz positioned ~.5 ~.5 ~.5 summon item_display at @s run function iyc:custom_blocks/slate_block/place_secondary
...
scoreboard players add #total_slate_block iyc.data 1
