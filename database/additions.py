...
database_additions = {
	...
	"bolt": {"id": CUSTOM_ITEM_VANILLA, "lore": ['{"text":"x1.5 damage arrow","color":"gray","italic":false}'], RESULT_OF_CRAFTING:[{"type":"crafting_shapeless","result_count":1,"category":"equipment","ingredients":[ingr_repr("minecraft:iron_ingot"),ingr_repr("minecraft:arrow")]}]},
	...
	"helice_hat": {"id": CUSTOM_ITEM_VANILLA, "lore": ['{"text":"A hat that makes you fly","color":"gray","italic":false}'], RESULT_OF_CRAFTING:[{"type":"crafting_shapeless","result_count":1,"category":"equipment","ingredients":[ingr_repr("minecraft:iron_ingot"),ingr_repr("minecraft:elytra")]}], "attributes_modifiers":[{"type":"generic.gravity","uuid":UUIDS["gravity"]["helmet"],"name":"generic.gravity","amount":-0.9,"operation":"add_value","slot":"head"}]},
	"hops_seeds": {"id": CUSTOM_ENTITY_VANILLA},
	"iron_ladder": {"id": CUSTOM_BLOCK_VANILLA, RESULT_OF_CRAFTING:[{"type":"crafting_shaped","result_count":4,"category":"misc","shape":["X X","XXX","X X"],"ingredients":{"X":ingr_repr("minecraft:iron_ingot")}}]},
