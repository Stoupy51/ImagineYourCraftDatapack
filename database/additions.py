...
database_additions = {
	...
	"helice_hat": {"id": CUSTOM_ITEM_VANILLA, "lore": ['{"text":"A hat that makes you fly","color":"gray","italic":false}'], RESULT_OF_CRAFTING:[{"type":"crafting_shapeless","result_count":1,"category":"equipment","ingredients":[ingr_repr("minecraft:iron_ingot"),ingr_repr("minecraft:elytra")]}], "attribute_modifiers":[{"type":"generic.gravity","uuid":UUIDS["gravity"]["helmet"],"name":"generic.gravity","amount":-0.9,"operation":"add_value","slot":"head"}]},
