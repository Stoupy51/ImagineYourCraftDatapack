...
def main(database: dict[str, dict]) -> dict[str, dict]:
	...
	database_additions = {
		...
		"beer":				{"id": CUSTOM_ITEM_VANILLA, CATEGORY: "food", "food":{"can_always_eat":True, "nutrition":2,	"saturation":0.6, "effects":[{"effect":{"id":"minecraft:nausea","duration":30*20,"amplifier":0},"probability":1.0}]}, 			RESULT_OF_CRAFTING:[{"type":"crafting_shapeless","result_count":1,"category":"food","ingredients":[ingr_repr("beer_mug", NAMESPACE),ingr_repr("hops", NAMESPACE)]}]},
		"cherry":			{"id": CUSTOM_ITEM_VANILLA, CATEGORY: "food", "food":{"can_always_eat":True, "nutrition":2,	"saturation":0.8}},
		"cherry_cake":		{"id": CUSTOM_BLOCK_VANILLA, CATEGORY: "food", 																																												RESULT_OF_CRAFTING:[{"type":"crafting_shapeless","result_count":1,"category":"food","ingredients":[ingr_repr("cherry", NAMESPACE),ingr_repr("minecraft:cake")]}]},
		...
		"nutella":			{"id": CUSTOM_ITEM_VANILLA, CATEGORY: "food", "food":{"can_always_eat":False, "nutrition":10,	"saturation":0.6}, 																											RESULT_OF_CRAFTING:[{"type":"crafting_shapeless","result_count":1,"category":"food","ingredients":[ingr_repr("minecraft:cocoa_beans")]*3 + [ingr_repr("minecraft:sugar")]*2 + [ingr_repr("minecraft:milk_bucket"), ingr_repr("glass_pot", NAMESPACE)]}]},
		"nutella_toast":	{"id": CUSTOM_ITEM_VANILLA, CATEGORY: "food", "food":{"can_always_eat":False, "nutrition":12,	"saturation":0.6}, 																											RESULT_OF_CRAFTING:[{"type":"crafting_shapeless","result_count":4,"category":"food","ingredients":[ingr_repr("nutella", NAMESPACE)] + [ingr_repr("toast", NAMESPACE)]*4}]},
